...
const BlackFridayBanner = async() => {
    ...
    return (
        <div className="bg-gradient-to-r from-red-600 to-black text-white px-6 py-10 mx-4 mt-2 rounged-lg shadow-lg"> 
            <div className="containter mx-auto flex items-center justify-between">
                <div className="flex-1">
                    ...
                    <div className="flex">
                        <div className="rounded-full bg-white text-black py-4 px-6 shadow-md transform hover:scale-105 duration-300">
